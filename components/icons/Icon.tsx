...
const SvgIcon: React.FC<IconProps & { children: React.ReactNode }> = ({ className, children }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      {children}
    </svg>
);

export const ChurchIcon: React.FC<IconProps> = ({ className }) => (
...
export const ShieldIcon: React.FC<IconProps> = ({ className }) => (
    <SvgIcon className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.944A12.02 12.02 0 0012 22.02a12.02 12.02 0 009-1.076A12.02 12.02 0 0021 12.054a11.955 11.955 0 01-5.382-8.07z" />
    </SvgIcon>
);
...
export const TruckIcon: React.FC<IconProps> = ({ className }) => (
    <SvgIcon className={className}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M13 17H6V6h11v5m0 0l4 4m-4-4H4" />
    </SvgIcon>
);

export const MegaphoneIcon: React.FC<IconProps> = ({ className }) => (
    <SvgIcon className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.144-6.126A1.76 1.76 0 015.44 11.34l4.286-1.607a1.76 1.76 0 012.274 1.143z" />
    </SvgIcon>
);
...
export const ArrowLeftStartOnRectangleIcon: React.FC<IconProps> = ({ className }) => (
    <SvgIcon className={className}>
